...
class task {
    public static void task0(long fileSize, boolean first_item, Elements stock_Name, Elements stock_price, Document doc) throws IOException{
...
public class HtmlParser2 {
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            task.task0(fileSize, first_item, stock_Name, stock_price, doc);
            } catch (IOException e) {
                e.printStackTrace();
            }
